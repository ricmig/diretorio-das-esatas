...
function esata($esataArray){
    ...
    try{
          ...
          $query = $conexao->prepare("SELECT id_esata, nomefantasia, cnpj, razaosocial, endereco, telefoneEmp, emailEmp, nomeResp, telefoneResp, emailResp, id_adicionado_por from esata");
