...
include '../controller/cadastrarEsataController.php';
?>
<div class="table-title">
        <div class="row">
          ...
          <?php endif; ?>
          <form action="cadastrar-esata-adm.php" method="post" class="user">
            ...
            <h4 class="alert-heading">Selecione os aeroportos:</h4>
              <select multiple class="custom-select my-1 mr-sm-2 b-radius" name="inputAeroporto[]" id="inputAeroporto">
                  <?php foreach ($aeroportosArrayE as $key => $value): ?>
